...
// platformFS embeds bin/darwin_arm64 — every reference plugin executable built
// for darwin/arm64, plus the .gitkeep placeholder that keeps this
...
const platformDir = "bin/darwin_arm64"
