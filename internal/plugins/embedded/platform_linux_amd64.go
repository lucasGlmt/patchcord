...
// platformFS embeds bin/linux_amd64 — every reference plugin executable built
// for linux/amd64, plus the .gitkeep placeholder that keeps this
...
const platformDir = "bin/linux_amd64"
